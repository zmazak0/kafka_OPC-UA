...
INSTANCE_NAME = os.environ.get('INSTANCE_NAME', 'MAI_IoT-kafka-opcua')
# Параметры подключения для OPC UA
OPCUA_SERVER = os.environ.get('OPCUA_SERVER', '127.0.0.1')
OPCUA_PORT = os.environ.get('OPCUA_PORT', '4840')
# Параметры подключения для Apache Kafka
KAFKA_SERVER = os.environ.get('KAFKA_SERVER', '127.0.0.1')
KAFKA_PORT = os.environ.get('KAFKA_PORT', '9092')
KAFKA_TOPIC = os.environ.get('KAFKA_TOPIC', 'MAI_IoT')
